...
{
    const std::uint32_t messageID = e->getMessageId();
    const std::uint32_t directionInd = 0x10;
    const std::uint32_t timeoutInd = 0x20;
    const std::uint32_t foodInd = 0x40;
    const std::uint32_t foodResp = 0x42;
